...
export default function Dashboard() {
  ...
  const { sortedData, sortCriteria, sortByCriteria, setSortedData } = useProjectSorting<ProjectWithMetrics>(projects);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-between">
              ...
              {sortCriteria !== 'none' && (
                <span className="text-sm text-gray-600">
                  Ordenado por: {
                    sortCriteria === 'successRate' ? 'Tasa de Éxito' :
                    sortCriteria === 'testRuns' ? 'Test Runs' :
                    sortCriteria === 'coverage' ? 'Cobertura' : ''
                  }
                </span>
              )}
            </div>
                  ...
                  {sortedData.map((project: ProjectWithMetrics) => (
                    <tr key={project.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{project.product}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr key={project.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {project.metrics.averageErrorRate !== undefined ? (
                          <span className={project.metrics.averageErrorRate > 5 ? 'text-red-600 font-semibold' : 'text-green-600'}>
                    ...
                    <tr key={project.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {project.metrics.averageSecurityScore !== undefined ? (
                          <span className={project.metrics.averageSecurityScore >= 80 ? 'text-green-600 font-semibold' : project.metrics.averageSecurityScore >= 50 ? 'text-yellow-600' : 'text-red-600 font-semibold'}>
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <LineChart data={generateTrendData(stats.averageSuccessRate, timePeriod)}>
                  ...
                  <YAxis domain={[0, 100]} />
                  <Tooltip />
                  <Line type="monotone" dataKey="exito" stroke={CHART_COLORS.success} strokeWidth={3} name="Tasa de Éxito %" />
                </LineChart>
              </ResponsiveContainer>
            </div>
      ...
      >
        ...
        >
          <div>
            <label htmlFor="global-edit-project" className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div>
            <label htmlFor="global-edit-testcases" className="block text-sm font-medium text-gray-700 mb-1">
      ...
      {(() => {
        ...
        return (
          ...
          >
            ...
            >
              <div>
                <label htmlFor="global-delete-project" className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        El proyecto <strong>"{projectName}"</strong> tiene <strong>{selectedProject?.metrics.testRunsCount} test run{selectedProject?.metrics.testRunsCount !== 1 ? 's' : ''}</strong> asociado{selectedProject?.metrics.testRunsCount !== 1 ? 's' : ''}.
                        <br />
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-sm text-red-700 mt-1">
                        ...
                        <br />
                        Esta acción no se puede deshacer y tendrás que crear el proyecto nuevamente si deseas gestionarlo otra vez.
                      </p>
                    </div>
                  </div>
                </div>
